                ...
                <div class="card card-profile">
                    <div class="card-body">
                        ...
                        <p class="card-description">
                            <a href="#" data-toggle="modal" data-target="#eventFullInfoModal"
                                data-title="{{$event->title}}" data-date="{{$event->date}}"
                                data-religion="{{ $event->religion->name }}" data-message="{{ $event->message }}">Full
                                Info</a>
                        </p>
                        <a href="{{route('events.edit',$event->id)}}" class="btn btn-info" style="padding:8px"><span
                                class="material-icons">edit</span></a>
                        <a href="#" class="btn btn-danger" style="padding:8px" data-toggle="modal"
                            data-target="#EDeleteModal" data-id="{{$event->id}}" id="eDeleteBtn-{{$event->id}}">
